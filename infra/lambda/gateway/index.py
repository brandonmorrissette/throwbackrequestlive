"""
A module that implements an AWS Lambda function to act as a gateway proxying HTTP requests
"""
...
def handler(event, context):  # pylint: disable=unused-argument, too-many-locals
    """Lambda function handler to proxy HTTP requests to a Fargate service."""
    ...
    resp_headers = {
        k: v for k, v in resp.raw.headers.items() if k.lower() not in HOP_BY_HOP
    }

        ...
        runtime_construct = RuntimeEcsConstruct(
            ...
            RuntimeEcsConstructArgs(
                ...
                runtime_variables={
                    ...
                    "COGNITO_APP_CLIENT_ID": args.user_management_stack.user_pool_construct.user_pool_client_id,
                    "COGNITO_USER_POOL_ID": args.user_management_stack.user_pool_construct.user_pool_id,
